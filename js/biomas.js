/* biomas.js - las diez comarcas que atraviesa la senda. Aquí no se dibuja ni
   se juega: solo se declara cómo es cada tramo -planta, colores, remate de los
   muros, afueras, adornos, trampas y aire-. El HUD, el mapa y el decorado leen
   de aquí, así que añadir o reordenar comarcas es tocar solo esta lista.
   ============================================================ */
'use strict';
...
const BIOMAS = [
    ...
    // ---------------------------------------------------------
    {
        ...
        // el único tramo con hierro en el suelo
...
const Biomas = {
    ...
    // el nombre traducido por el id de la comarca; el de la ficha queda de red
    // por si falta idiomas.js o la clave
    nombre(nivel) {
    ...
    // el dibujo con que firma la comarca, en currentColor: lo tiñe quien lo
    // enseñe, y el HUD lo hace con el tinte de esta misma ficha
    emblema(nivel) { return Biomas.deNivel(nivel).emblema || ""; },

    // el color con que la comarca se reconoce de un vistazo, con el oro de
    // siempre de red
    tinte(nivel) {
